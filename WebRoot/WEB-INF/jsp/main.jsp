...
<script src="js/dwz.demo/dwz.core.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.util.date.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.validate.method.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.regional.zh.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.barDrag.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.drag.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.tree.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.accordion.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.ui.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.theme.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.switchEnv.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.alertMsg.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.contextmenu.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.navTab.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.tab.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.resize.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.dialog.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.dialogDrag.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.sortDrag.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.cssTable.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.stable.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.taskBar.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.ajax.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.pagination.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.database.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.datepicker.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.effects.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.panel.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.checkbox.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.history.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.combox.js" type="text/javascript"></script>
<script src="js/dwz.demo/dwz.print.js" type="text/javascript"></script>
