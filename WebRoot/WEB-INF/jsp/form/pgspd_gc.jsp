...
<div class="pageFormContent">
	...
	<p>
		<label> 工程名称：</label>
		<input class="required" type="text" name="Td01_xmxx.XMMC" style="width:405px;" value="${td00_gcxx.gcmc}" />
	</p>
	<p>
		<label>工程编号：</label>
		<input class="required" type="text" name="Td01_xmxx.XMBH" style="width:120px;" value="${td00_gcxx.gcbh}" />
	</p> 
	<div style="height:0px;"></div>
	<p>
		<label>审批类别： </label>
