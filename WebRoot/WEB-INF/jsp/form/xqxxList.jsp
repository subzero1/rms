			...
			<tbody>
				...
				<c:set var="offset" value="${offset+1}"/>
					<tr target="xq_id" rel="${obj.id}">
						...
						<td><a href="openForm.do?project_id=${obj.id }&module_id=101&doc_id=${obj.id }&user_id=${user.id }&limit=${limit }&node_id=${node_id }" target="navTab" rel="xmxx" title="项目信息单">${obj.xqmc }</a></td>
						<td>${obj.jsxz }&nbsp;</td>
						<td>${obj.ssdq }</td>
						<td>${obj.jd }</td>
						<td>${obj.wd }</td>
