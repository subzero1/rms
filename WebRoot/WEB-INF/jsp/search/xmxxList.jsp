...
<div class="page">
	<div class="pageHeader">
		<form action="search/xmxxList.do" method="post"onsubmit="return navTabSearch(this);">
			<div class="searchBar">
				...
				<div class="subBar">
					<ul>
						<li><div class="buttonActive"><div class="buttonContent"><button type="button" onClick="javascript:searchOrExcelExport(this,'search/xmxxList.do',navTabSearch);">检 索</button></div></div></li>
					</ul>
				</div>
			</div>
		</form>
		...
		<table class="table" width="100%" layouth="138">
			<thead>
				<tr>
					...
					<th style="width: 65px;" orderField="gclb">项目类别</th>
					<th style="width: 70px;" orderField="xmgly">项目管理员</th>
					<th style="width: 200px;" orderField="sgdw">施工单位</th>
					<th style="width: 65px;" orderField="sjjgsj">竣工时间</th>
					<th style="width: 140px;" orderField="jssj">决算时间</th>
