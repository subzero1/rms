...
<script type="text/javascript">
	...
	$(function(){
		$("#daihui",$.pdialog.getCurrent()).click(function(){     
			...
			var names=$("#names",$.pdialog.getCurrent()).val();  
			$.bringBack({'YSRY':names,'OBJ_ID':ids}); 
		});
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="form/selectYsry.do" onsubmit="return dwzSearch(this, 'dialog');">
...
<div class="pageContent">
	...
	<table class="table" layoutH="118" targettype="dialog" width="100%">
		...
		<thead>
			<tr>
				<th orderfield="name">验收人员</th> 
				<th width="40">选择</th>
			</tr>
		</thead>				
		<tbody>
			<c:forEach items="${ysryList}" var="obj"> 
			<tr>
				<td>${obj.name}</td> 
				<td>
						<a class="btnSelect" href="javascript:addKcry('${obj.id }','${obj.name }')" title="查找带回">
				</td>
			</tr> 
			</c:forEach>
		</tbody>
