...
<div class="page">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="exportexcel"	href="wxdw/gcKcList.do?project_id=${gcxx.id }&toExcel=yes" target="dwzExport" targetType="navTab"><span>导出</span></a></li>
		...
		<table class="table" width="100%" layouth="138">
			<thead>
				<tr>
					...
					<th style="width: 100px;" orderField="kcsl">数量</th>
			...
			<c:set var="offset" value="0"/>
				...
				<c:set var="offset" value="${offset+1}"/>
					<tr>
						...
						<td>${obj.dw }</td>
						<td>${obj.kcsl }</td>
						<td><c:if test="${gcxx.id == -1 }"><a style="margin-left:3px;color:darkblue" href="wxdw/zhuanchuList.do?id=${obj.id }" target="dialog" rel="zhuanchu" width="500" height="300">转出</a></c:if></td>
					</tr>
				</c:forEach>
