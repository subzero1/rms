		...
		<div class="panelBar">
			<ul class="toolBar">
				<c:if test="${not empty param.wxdw_id }">
					<li><a class="add" href="wxdw/wxdwUserEdit.do?wxdw_id=${param.wxdw_id }" target="dialog" width="500" height="330" rel="wxdwUser" title="外协单位用户配置"><span>添加</span></a></li>
					<li class="line">line</li>
					<li><a class="edit" href="wxdw/wxdwUserEdit.do?wxdw_id=${param.wxdw_id }&id={user_id}" target="dialog" width="500" height="330" rel="wxdwUser" title="外协单位用户配置"><span>修改</span></a></li>
					<li class="line">line</li>
