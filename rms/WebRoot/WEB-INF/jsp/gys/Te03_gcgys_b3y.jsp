...
<head>
<title>建筑安装工程施工机械使用费概预算表（表三）乙</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="978" style="border-collapse:collapse;" class="black-title">
  	<tr>
 		<th colspan="8" class="t-center"><h2>建筑安装工程施工机械使用费概预算表（表三）乙</h2></th>
 	</tr>
    <tr>
  ...
  <table border="1" cellpadding="0" cellspacing="0" width="978" style="border-collapse:collapse;" class="black-box">
    <tr>
      ...
      <th height="19" width="228" rowspan="2">项目名称</th>
      <th height="19" width="150" rowspan="2">机械名称</th>
      <th height="19" width="60" rowspan="2">单位</th>
      <th height="19" width="60" rowspan="2">数量</th>
      <th height="7" width="140" colspan="2">单位定额值</th>
      <th height="7" width="140" colspan="2">概、预算值</th>
      <th height="37" width="90" rowspan="3">备注</th>
    </tr>
    <tr>
