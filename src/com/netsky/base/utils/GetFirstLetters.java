...
public class GetFirstLetters {
    static final int GB_SP_DIFF=160;
    // 存放国标一级汉字不同读音的起始区位码
    final int[] secPosValueList = { 1601, 1637, 1833, 2078, 2274, 2302, 2433, 2594, 2787, 3106, 3212,
    ...
    public static void main(String[] args){
    	System.out.println(new GetFirstLetters().getSpells("李梓赫李翔宇皓缪"));
    }
}