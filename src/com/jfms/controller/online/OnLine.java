package com.jfms.controller.online;
...
public class OnLine {
	...
	public void onlinezdajax(HttpServletRequest request,
		...
		try {
			...
			saveService.updateByHSql("update Te03_online set flag=" + flag
					+ " where id=" + id);
			out
					.print("{\"statusCode\":\"200\", \"message\":\"置顶修改成功\", \"navTabId\":\"OnLineList\", \"forwardUrl\":\"OnLineList.do\", \"callbackType\":\"\"}");
		} catch (Exception e) {
			exceptionService.exceptionControl(
	...
	public void onlineanswerdelajax(HttpServletRequest request,
		...
		String returnurl = "{\"statusCode\":\"200\", \"message\":\"删除成功\", \"navTabId\":\"OnLineList\", \"forwardUrl\":\"OnLineanswer.do?aq_id="+up_id+"\", \"callbackType\":\"forward\"}";
		try {
			out = response.getWriter();
			// 删除
			OperFile of = new OperFile();
