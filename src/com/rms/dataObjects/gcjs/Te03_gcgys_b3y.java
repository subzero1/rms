 ...
 * @hibernate.class table="Te03_gcgys_b3y"
 */
public class Te03_gcgys_b3y implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 7179817867871453552L;
	/**
	 * id
	 */
	private Long id ;
	 ...
	 * @hibernate.generator-param name="sequence" value="TE03B3YNUM"
	...
	/**
	 * @hibernate.property column="jxmc"
	 * @return jxmc
	 */
